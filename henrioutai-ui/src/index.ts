// @henrioutai/ui — the henrioutai design system.
// Token-only, framework-agnostic-of-business React components. No API client,
// no data fetching, no product logic — those live in the consuming app.
// Colors come from CSS custom properties in styles/; dark mode is one token
// remap under :root[data-bg-theme="dark"].
