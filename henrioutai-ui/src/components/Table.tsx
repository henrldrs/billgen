...
export interface TableColumn<T> {
  key: string;
  label: ReactNode;
  /** Right-aligned, rendered in Geist Mono tabular figures (.bg-num). */
  numeric?: boolean;
  /** Header becomes a button; clicking it calls onSortChange. */
  sortable?: boolean;
...
export interface TableProps<T> {
  ...
  /** Current sort — the component displays it; the caller sorts the rows. */
  sort?: TableSort;
...
/**
 * Data table: sortable header affordance, numeric columns in mono tabular
 * figures, optional clickable rows. Presentational only — sorting is the
 * caller's job (flip `sort`, reorder `rows`).
 */
