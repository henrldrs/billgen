# Audit diff — audit-002 against audit-001

audit-002 vs audit-001: 1 new, 19 still open, 0 regressed, 2 resolved
...
- `ARCH-DOC-001` 8 endpoint(s) documented in system-architecture.html do not exist in the router tree (MEDIUM)
- `ARCH-DOC-002` 50 registered endpoint(s) appear nowhere in system-architecture.html (LOW)
