...
export type AcceptanceResponse = components["schemas"]["AcceptanceResponse"];
...
export type PrivacyEraseResponse = components["schemas"]["PrivacyEraseResponse"];
...
export type VatTreatmentResponse = components["schemas"]["VatTreatmentResponse"];
