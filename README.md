...
|---|---|---|
| `core/` | 1 — Business | Pure Python. Models, services, rules, repository ports, PDF (headless Chromium — the installed Edge on Windows, Playwright's build in the container), e-invoicing (Peppol BIS 3.0 / UBL 2.1 / EN 16931). No FastAPI, no ORM, no React imports. |
